...
#define GET_MESH(T, objName) engine::MeshSource<T>::get()->getMesh(objName)
#define GET_OBJ(objName) GET_MESH(ObjVertex, objName)
#define GET_SCENE_MESH(objName) toMeshComponent(GET_OBJ(objName))
